...
namespace CarRental.Business.Concrete
{
    public class AuthManager : IAuthService
    {
        ...
        public IDataResult<User> Login(UserForLoginDto userForLoginDto)
        {
            ...
            {
                return new ErrorDataResult<User>(Messages.User.WrongPassword);
            }

            return new SuccessDataResult<User>(userToCheck.Data, Messages.User.UserExist);
        }
        ...
        public IResult UserExists(string email)
        {
            ...
            {
                return new ErrorResult(Messages.User.UserExist);
            }
